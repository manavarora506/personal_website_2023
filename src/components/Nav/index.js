  ...
  return (
    <nav className="flex items-center justify-between p-4 md:p-6 sticky top-0">
      <div className="flex items-center flex-shrink-0 ml-0 md:ml-4 mr-6">
        ...
        <button
          className="items-center bg-off-white ml-2 rounded dark:bg-off-black focus:outline-none"
          onClick={toggleTheme}
        >
          {isDark ? (
            // Sun Icon
            <svg
              ...
              height="16"
              strokeWidth="0.25"
              className="inline-block stroke-current fill-current text-off-black dark:text-off-white hover:text-sky-500 dark:hover:text-sky-500 transition duration-300"
              viewBox="0 0 18 18"
            >
        ...
        <div className="text-sm md:text-base font-normal md:font-medium md:flex-grow">
          ...
          <Link href="/static/pdf/Manav-Arora-Resume.pdf">
            <a
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mr-3 text-primary hover:text-sky-500"
            >
              Resume
            </a>
          </Link>
